...
const Geolocalizacion = () => {
    ...
    // Estado para guardar ubicación, dirección y errores
    ...
    const { isLoaded, loadError } = useLoadScript({
        googleMapsApiKey: "AIzaSyBpCefRKrNut7ZrQPgVuLTkdWXmc556Lm4", // Asegúrate de usar una API key válida
    });

    // Obtener coordenadas de geolocalización con mejor manejo de errores
    useEffect(() => {
    ...
    // Función mejorada para obtener la dirección
