...
const Comunidades = () => {
    ...
    useEffect(() => {
        ...
        const fetchCommunities = async () => {
            try {
                const response = await fetch(`https://inti-sayri-backend-latest.onrender.com/api/communities/by-user/${nombreUsuario}`);
    ...
    const handleAddChat = async () => {
        if (newChat.title) {
            try {
                const response = await fetch(`https://https://inti-sayri-backend-latest.onrender.com/api/communities/by-user/${nombreUsuario}`, {
                    method: 'POST',
                    headers: {
